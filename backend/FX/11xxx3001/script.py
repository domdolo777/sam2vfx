...
def apply_effect(frame, mask, **params):
    ...
    # Apply mask to limit effect to selected area
    ...
    def pixel_sort(image, mask, direction, style, thresh_min, thresh_max, strip_width, strip_spacing, pulling_distance):
        ...
        # Threshold mask for sorting (combine with input mask)
        threshold_mask = ((channel_to_sort >= min_thresh_value) & (channel_to_sort <= max_thresh_value)) & mask
    ...
    # Apply pixel sorting based on the specified direction and mask
