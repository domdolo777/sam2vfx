...
def apply_effect(frame, **params):
    ...
    def pixel_sort(image, style, thresh_min, thresh_max, strip_width, strip_spacing, pulling_distance):
        ...
        # Mask for threshold range (now applying to the entire image)
    ...
    sorted_image = pixel_sort(frame_with_rotated_strips, sorting_style, thresh_min, thresh_max, strip_width, strip_spacing, pulling_distance)
