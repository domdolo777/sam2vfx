# Adjusted version to handle shape mismatch during pixel sorting
import cv2
import numpy as np
...
# Load the image attached by the user
input_image_path = '/mnt/data/echo.png'
...
output_image_path = '/mnt/data/pixel_sorted_output.png'
