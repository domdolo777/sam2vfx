...
def apply_effect(frame, mask, invert_mask=False, **params):
    if not params:
        params = {}
    ...
    # If mask inversion is requested, invert the mask
    if invert_mask:
    ...
    def pixel_sort(image, mask, style, thresh_min, thresh_max, strip_width, strip_spacing, pulling_distance):
        ...
        # Combine the threshold mask with the user-provided mask
